...
class historical_website_discount():
    ...
    def historical_puller(self, link,country):
        ...
        discount=''
        print(list1,list2,index1,index2)
...
if __name__ == "__main__":
    ...
    new_dict = {"US":"http://www.hm.com/us","UK":"http://www2.hm.com/en_gb/index.html","China":"http://www2.hm.com/en_cn/index.html"}
    #'Germany':'http: // www.hm.com / de'}
